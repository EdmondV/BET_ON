...
import { normalizeY, calculateMeta } from '../../../modules/rooms/utils';
import VideoPlayer from '../RightPanel/VideoPlayer/VideoPlayer';

import Grid from './Grid';
import smooth from './Smooth';
import line from './line';
import { makeNewBet, toggleWidget } from '../FootballPage/actions';
import bgImage from '../FootballPage/mocks/assets/main_chart_bg.jpg';
import { getMatchData, getMatchEvents, EVENT_TYPES } from '../FootballPage/mocks/matchesData';
import ChartEventLog from './ChartEventLog';
import ChartEventIcons from './ChartEventIcons';
import PreloadingScreen from '../FootballPage/PreloadingScreen/PreloadingScreen';

import ChartSettings from './ChartSettings';
import bgImg from '../FootballPage/mocks/assets/runningFP.png';
...
export class Chart extends React.Component {
  ...
  render() {
    ...
    >
      ...
      />
      <Widget
        isShow={this.props.isWidgetShow && (this.props.room.id === 1 || this.props.room.id === 2)}
        ...
        toggleProjection={(index) => this.setState({ selectedProjection: index })}
        chartWidth={width}
        chartHeight={height}
      />
      <ChartEventIcons
      ...
      />
      <ChartEventLog
        isWidgetShow={this.props.isWidgetShow && (this.props.room.id === 1 || this.props.room.id === 2)}
