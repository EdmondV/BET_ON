...
export default function BaseballIcon() {
  return (
    <svg x="0px" y="0px" viewBox="0 0 117.7 117.3">
      <g>
        <path
          d="M17.8,88.2l2.8-3.8l4.2,2.8c1.9-3.3,3.8-6.6,5.2-10.3l-4.7-1.4l1.4-4.7l4.7,1.4c0.9-3.8,1.4-7.5,1.9-11.3h-4.7v-4.7h4.7
        ...
        />
        <path
          d="M101.8,18.8c-2.3,2.4-4.7,4.7-6.6,7l4.2,2.8l-2.8,4.2L92.4,30c-1.9,3.3-3.8,6.6-5.2,10.3l4.7,1.4l-1.4,4.7L85.9,45
        ...
        />
        <path
          d="M88.2,96.6l-2.8-3.8l3.8-2.3c-2.3-3.8-4.2-7.5-5.6-11.7l-4.7,0.9l-1.4-4.7l4.2-1.4c-0.9-3.7-1.9-8.4-1.9-12.7h-4.7v-4.7
